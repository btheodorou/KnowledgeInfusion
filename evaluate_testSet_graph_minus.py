...
pickle.dump(intermediate, open("./results/testing_stats/Graph_Minus_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/testing_stats/Graph_Minus_Metrics.pkl", "wb"))
