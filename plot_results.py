...
base_speed = 2
processing_speed = 2
consequence_speed = 2 + 30/60 + 0/3600
ccn_speed = 4 + 54/60 + 0/3600
loss_speed = 3
...
gen_speeds = [base_avg_speed, processing_avg_speed, consequence_avg_speed, ccn_avg_speed, loss_avg_speed]
gen_err = [base_error, processing_error, consequence_error, ccn_error, loss_error]
train_speeds = [base_speed, processing_speed, consequence_speed, ccn_speed, loss_speed]
train_err = [0, 0, 0, 0, 0]
...
ax1.set_ylabel("Generation Speed (patients/sec)")
...
models = ['Vanilla\nGeneration', 'Post\nProcessed', 'ConSequence', 'CCN', 'Semantic\nLoss']
violations = [base_avg_violations, processing_avg_violations, consequence_avg_violations, ccn_avg_violations, loss_avg_violations]
violations_err = [base_error, processing_error, consequence_error, ccn_error, loss_error]
static_violations = [base_avg_static_violations, processing_avg_static_violations, consequence_avg_static_violations, ccn_avg_static_violations, loss_avg_static_violations]
static_violations_err = [base_static_error, processing_static_error, consequence_static_error, ccn_static_error, loss_static_error]
temporal_violations = [base_avg_temporal_violations, processing_avg_temporal_violations, consequence_avg_temporal_violations, ccn_avg_temporal_violations, loss_avg_temporal_violations]
temporal_violations_err = [base_temporal_error, processing_temporal_error, consequence_temporal_error, ccn_temporal_error, loss_temporal_error]
validity = [base_avg_validity, processing_avg_validity, consequence_avg_validity, ccn_avg_validity, loss_avg_validity]
validity_err = [base_validity_error, processing_validity_error, consequence_validity_error, ccn_validity_error, loss_validity_error]
...
models = ['Vanilla\nGeneration', 'Post\nProcessed', 'ConSequence', 'CCN', 'Semantic\nLoss']
individual = [base_r2[0][0], processing_r2[0][0], consequence_r2[0][0], ccn_r2[0][0], loss_r2[0][0]]
individual_err = [base_r2[0][1], processing_r2[0][1], consequence_r2[0][1], ccn_r2[0][1], loss_r2[0][1]]
coocurring = [base_r2[1][0], processing_r2[1][0], consequence_r2[1][0], ccn_r2[1][0], loss_r2[1][0]]
coocurring_err = [base_r2[1][1], processing_r2[1][1], consequence_r2[1][1], ccn_r2[1][1], loss_r2[1][1]]
sequential = [base_r2[2][0], processing_r2[2][0], consequence_r2[2][0], ccn_r2[2][0], loss_r2[2][0]]
sequential_err = [base_r2[2][1], processing_r2[2][1], consequence_r2[2][1], ccn_r2[2][1], loss_r2[2][1]]
fig, ax1 = plt.subplots(figsize=(8, 6))
