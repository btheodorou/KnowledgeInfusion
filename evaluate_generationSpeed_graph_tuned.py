...
pickle.dump(secondsPerPatient, open('./results/generationSpeeds/graphTunedSpeed.pkl', 'wb'))
pickle.dump(synthetic_ehr_dataset, open(f'./results/graphTunedDataset.pkl', 'wb'))