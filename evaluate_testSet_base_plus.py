...
pickle.dump(intermediate, open("./results/testing_stats/Base_Plus_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/testing_stats/Base_Plus_Metrics.pkl", "wb"))
