...
pickle.dump(intermediate, open("./results/testing_stats/Loss_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/testing_stats/Loss_Metrics.pkl", "wb"))
