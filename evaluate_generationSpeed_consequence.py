...
for run in tqdm(range(RUNS)):
  ...
  pickle.dump(secondsPerPatient, open(f'./results/generationSpeeds/conSequenceSpeed_{run}.pkl', 'wb'))
  pickle.dump(synthetic_ehr_dataset, open(f'./results/conSequenceDataset_{run}.pkl', 'wb'))
