...
pickle.dump(secondsPerPatient, open('./results/generationSpeeds/conSequenceSpeed.pkl', 'wb'))
pickle.dump(synthetic_ehr_dataset, open(f'./results/conSequenceDataset.pkl', 'wb'))