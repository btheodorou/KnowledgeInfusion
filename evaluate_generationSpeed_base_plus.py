...
pickle.dump(secondsPerPatient, open('./results/generationSpeeds/basePlusSpeed.pkl', 'wb'))
pickle.dump(synthetic_ehr_dataset, open(f'./results/basePlusDataset.pkl', 'wb'))