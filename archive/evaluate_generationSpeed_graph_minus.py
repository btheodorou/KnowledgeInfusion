...
pickle.dump(secondsPerPatient, open('./results/generationSpeeds/graphMinusSpeed.pkl', 'wb'))
pickle.dump(synthetic_ehr_dataset, open(f'./results/graphMinusDataset.pkl', 'wb'))