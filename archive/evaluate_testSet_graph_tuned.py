...
checkpoint = torch.load('./save/graph_model_tuned', map_location=torch.device(device))
...
pickle.dump(intermediate, open("./results/testing_stats/Graph_Tuned_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/testing_stats/Graph_Tuned_Metrics.pkl", "wb"))
