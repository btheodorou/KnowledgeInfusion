...
pickle.dump(intermediate, open("./results/testing_stats/Graph_New_Order_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/testing_stats/Graph_New_Order_Metrics.pkl", "wb"))
